...
from src.media.dependencies import get_file_storage, valid_media_id
...
@router.get(
    "", response_model=list[MediaRead], dependencies=[Depends(current_superuser)]
)
...
async def delete_media(
    ...
    await service.delete(media.id, session, storage)
